...
public class GashatRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(ItemStack pStack, ItemTransforms.TransformType pTransformType, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
        ...
        Renders.with(pPoseStack, () ->
                renderModel(pPoseStack, buffer, pTransformType, pPackedLight, pPackedOverlay));
    ...
    public void renderModel(PoseStack poseStack, VertexConsumer consumer, ItemTransforms.TransformType transformType, int light, int overlay) {
        ...
        BakedModel model = ForgeHooksClient.handleCameraTransforms(poseStack, Minecraft.getInstance().getModelManager().getModel(this.model.get()), transformType, transformType == ItemTransforms.TransformType.FIRST_PERSON_LEFT_HAND || transformType == ItemTransforms.TransformType.THIRD_PERSON_LEFT_HAND);
        poseStack.translate(-0.5, -0.5, -0.5);
