...
public class HyperJeiPlugin implements IModPlugin {
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        registration.addGhostIngredientHandler(VRXScreen.class, new IGhostIngredientHandler<>() {
            ...
            public <I> List<Target<I>> getTargetsTyped(VRXScreen screen, ITypedIngredient<I> ingredient, boolean doStart) {
                VRXJeiWrapper<I> wrapper = VRXOne.Type.cast(ingredient.getIngredient());
                if (wrapper != null) {
                    ...
                    return screen.getMenu().slots.stream()
                            .map(slot -> {
                                ...
                                } else if (ingredient.getIngredient() instanceof ItemStack) {
