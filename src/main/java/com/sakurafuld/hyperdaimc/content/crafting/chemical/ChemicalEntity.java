...
public class ChemicalEntity extends ThrownPotion {
    ...
    protected void onHit(HitResult pResult) {
        ...
        require(LogicalSide.SERVER).run(() -> this.getLevel().getEntities(this, this.getBoundingBox().inflate(2, 1, 2), EntitySelector.LIVING_ENTITY_STILL_ALIVE).stream()
        ...
        this.getLevel().levelEvent(LevelEvent.PARTICLES_SPELL_POTION_SPLASH, this.blockPosition(), 0x805080);
        this.discard();
    }
}
