...
public class DeskShapedRecipe implements IDeskRecipe, IShapedRecipe<RecipeWrapper> {
    ...
    public DeskShapedRecipe(ResourceLocation id, int width, int height, NonNullList<Ingredient> ingredients, ItemStack result, boolean minecraft) {
        this.id = id;
        this.width = width;
        this.height = height;
    ...
    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<DeskShapedRecipe> {
        @Override
        public DeskShapedRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new DeskShapedRecipe(pRecipeId, width, height, ingredients, result, minecraft);
        }
        ...
        public DeskShapedRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
            ...
            return new DeskShapedRecipe(pRecipeId, width, height, ingredients, pBuffer.readItem(), pBuffer.readBoolean());
        }
