...
public class NovelHandler {
    ...
    public static List<Entity> rayTraceEntities(Player player, double reach) {
        ...
        for (Entity entity : player.level().getEntities(player, area, PREDICATE_MULTIPLE)) {
        ...
        LOG.debug("RayTraceEntities:{}", entities);
        LOG.debug("RayTrace:start={},end={},area={}", start, end, area);
        return entities;
    }
    ...
    public static Entity rayTraceEntity(Player player, double reach) {
        ...
        for (Entity entity : player.level().getEntities(player, area, PREDICATE_SINGLE)) {
