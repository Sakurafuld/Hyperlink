...
//            RenderSystem.setShaderTexture(0, TEXTURE);
        ...
        public void renderTooltip(VRXScreen screen, GuiGraphics graphics, int x, int y) {
            if (screen.getMenu().getCarried().isEmpty()) {
                List<Component> tooltip = Lists.newArrayList();
                tooltip.add(Component.translatable("tooltip.hyperdaimc.vrx_energy"));
                tooltip.add(Component.translatable("tooltip.hyperdaimc.vrx_energy_description").withStyle(ChatFormatting.GRAY));
