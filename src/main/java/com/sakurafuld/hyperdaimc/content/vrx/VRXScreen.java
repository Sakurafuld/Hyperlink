...
public class VRXScreen extends AbstractContainerScreen<VRXMenu> {
    ...
    protected void renderTooltip(PoseStack pPoseStack, int pX, int pY) {
        if (this.hoveredSlot instanceof VRXSlot slot) {
            ...
            this.renderTooltip(pPoseStack, Collections.singletonList(new TranslatableComponent("tooltip.hyperdaimc.vrx_face", this.getFaceName()).withStyle(ChatFormatting.GRAY)), this.getMenu().getTooltip(), pX, pY);
        } else {
    ...
    public TranslatableComponent getFaceButton() {
        return new TranslatableComponent("container.hyperdaimc.vrx_face", this.getFaceName());
    }
