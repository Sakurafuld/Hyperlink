...
public class HyperTagsProvider extends ItemTagsProvider {
    ...
    public HyperTagsProvider(DataGenerator pGenerator, @Nullable ExistingFileHelper existingFileHelper) {
        super(pGenerator, new BlockTagsProvider(pGenerator, HYPERDAIMC, existingFileHelper), HYPERDAIMC, existingFileHelper);
    }

    @Override
    @SuppressWarnings("unchecked")
    protected void addTags() {
        Object2ObjectOpenHashMap<String, TagAppender<Item>> material = new Object2ObjectOpenHashMap<>();
        ...
        this.tag("essence/ground")
                ...
                .add(Items.SNOW, Items.SNOW_BLOCK, Items.CLAY)
        ...
        this.tag("essence/food")
                ...
                .add(Items.GOLDEN_CARROT, Items.GOLDEN_APPLE, Items.CAKE, Items.ENCHANTED_GOLDEN_APPLE)
